...
var convertArgType = require('../utils/convertArgType'); // region TYPEDEFS
...
function () {
  ...
  _createClass(Intermediary, [{
    ...
    value: function involve(target) {
      ...
      var throwOnMiddleware = arguments.length > 2 ? arguments[2] : undefined;
      return (
        /*#__PURE__*/
        _asyncToGenerator(function* () {
          ...
          var result = yield target.apply(void 0, _toConsumableArray(updatedArg));
    ...
    key: "series",
    value: function series(intermediaries, target, context) {
      /**
      ...
      return (
        ...
        _asyncToGenerator(function* () {
          ...
          var fakeTarget = function fakeTarget(result) {
            return result;
          };
          ...
          try {
            for (var _iterator3 = intermediaries[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              ...
              yield next.apply(void 0, arguments);
            }
          } catch (err) {
